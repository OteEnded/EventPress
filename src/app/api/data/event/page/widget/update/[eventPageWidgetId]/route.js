...
export async function POST(req, { params }) {
    ...
    try {
        ...
        request_body.event_page_widget_id = eventPageWidgetId;
        
        const requiredFields = ["event_page_widget_id", "option"];
        ...
        const page = await Page.updateEventPageWidget({
            event_page_widget_id: request_body.event_page_widget_id,
